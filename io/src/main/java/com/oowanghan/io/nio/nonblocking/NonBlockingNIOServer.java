...
public class NonBlockingNIOServer {
        ...
        while (selector.select() > 0){
            ...
            for (SelectionKey selectionKey : selectionKeys) {
                ...
                if (selectionKey.isAcceptable()){
                    dealAcceptableEvent(serverSocketChannel, selector, selectionKeys, selectionKey);
                }
                if (selectionKey.isReadable()){
                    dealReadableEvent(selectionKeys, selectionKey);
                }
            }
        }
    ...
    private static void dealReadableEvent(Set<SelectionKey> selectionKeys, SelectionKey selectionKey) throws IOException {
...
//                    }
    ...
    private static void dealAcceptableEvent(ServerSocketChannel serverSocketChannel,
                                            Selector selector,
